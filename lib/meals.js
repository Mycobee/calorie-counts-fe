$(document).ready(function(){
	...
	var getMeals = function() {
      ...
      url: "https://calorie-counts.herokuapp.com/api/v1/meals",
  		success: function (foundMeals) {
  			...
  			$(".meal-link").on("click", function() {
  				...
  				$.ajax({
  					type: "Get",
    			  contentType: "application/json; charset=utf-8",
    			  url: "https://calorie-counts.herokuapp.com/api/v1/meals/" + String(mealId) + "/foods",
              ...
              // List meal's foods
  						...
  						$.ajax({
  							type: "Get",
    					  contentType: "application/json; charset=utf-8",
    					  url: "https://calorie-counts.herokuapp.com/api/v1/foods",
              		...
              		$("#meals").append(foodAddHeader).append(foodDropDown).append(foodMealAddBtn).append(indexBtn)
  								...
  								$("#food-meal-add").on("click", function() {
  									$.ajax({
  										type: "Post",
    								  contentType: "application/json; charset=utf-8",
    								  url: `https://calorie-counts.herokuapp.com/api/v1/meals/${mealId}/foods/${$("#food-drop-down").val()}`,
									...
									//This ajax request deletes a food from meals
									$(".remove-food").on("click", function() {
										var mealId = $(this).attr('id').split('-')[0];
										var foodId = $(this).attr('id').split('-')[1];
										$.ajax({
											type: "Delete",
			  						  contentType: "application/json; charset=utf-8",
			  						  url: "https://calorie-counts.herokuapp.com/api/v1/meals/" + String(mealId) + "/foods/" + String(foodId),
